...
<sch:schema xmlns:sch="http://www.ascc.net/xml/schematron" 
  ...
  <sch:title>Rules for CSW-2.0.1 DescribeRecordResponse entities.</sch:title>
  ...
  <sch:pattern id="DescribeRecordResponsePattern" name="DescribeRecordResponsePattern">
	...
	The document element must have [local name] = "DescribeRecordResponse" and [namespace name] = "http://www.opengis.net/cat/csw".
      </sch:assert>
    </sch:rule>
  </sch:pattern>
  ...
  <sch:pattern id="DefaultSchemaComponentPattern" name="DefaultSchemaComponentPattern">
    ...
    <sch:rule id="DefaultSchemaComponent" context="/csw:DescribeRecordResponse/csw:SchemaComponent">
      <sch:assert id="DefaultSchemaComponent.targetNamespace" 
        test="@targetNamespace = 'http://www.opengis.net/cat/csw'">
	Expected csw:SchemaComponent/@targetNamespace: "http://www.opengis.net/cat/csw."
      </sch:assert>
      <sch:assert id="DefaultSchemaComponent.schemaLanguage" 
        test="@schemaLanguage = 'http://www.w3.org/XML/Schema'">
	Expected csw:SchemaComponent/@schemaLanguage: "http://www.w3.org/XML/Schema" 
      </sch:assert>
    </sch:rule>
  </sch:pattern>
